  ...
  if (logData.value) {
    ...
    for (let i = 0; i < 3; i++) {
      if ((option.value.series as any[])[i]) {
        switch (i) {
          case 0:
            (option.value.series as any[])[i].data = logData.value["UP_COUNT"];
            break;
          case 1:
            (option.value.series as any[])[i].data = logData.value["UP_INS_COUNT"];
            break;
          case 2:
            (option.value.series as any[])[i].data = logData.value["UP_CPT7_COUNT"];
            break;
        }
      }
    }
